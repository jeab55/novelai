...
function buildDraftPrompt(form, systemPrompt, wordTarget) {
  ...
  prompt += `2. โดยทั่วไปประกอบด้วยหลายฉาก มีทั้งบทบรรยายและบทสนทนา (เว้นแต่สไตล์นักเขียนหรือโจทย์ตอนกำหนดเป็นฉากเดียว/สัดส่วนอื่น)\n`;
  prompt += `3. เขียนเป็นเนื้อเรื่องต่อเนื่อง ไม่ใช่เค้าโครง ไม่ใช่สรุปย่อ ไม่ใช้ bullet points\n`;
  prompt += `4. ใช้ภาษาตามสไตล์ของนักเขียนประจำเรื่อง (ถ้านักเขียนไม่ได้ระบุ ให้ภาษาไทยสละสลวย อ่านลื่น เห็นภาพ มีอารมณ์และจังหวะ)\n\n`;
