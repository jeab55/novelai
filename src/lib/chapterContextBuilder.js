...
※ รูปแบบผลลัพธ์ (บังคับ — เป็นเรื่องรูปแบบการส่งออก ไม่ใช่การกลบสไตล์): การร่างตอนต้องส่งออกเป็น "เนื้อเรื่องนิยายร้อยแก้วเต็มตอน" เท่านั้น — แม้สไตล์นักเขียนจะระบุบทบาทเป็นโค้ช/ผู้ช่วย หรือให้ตั้งคำถาม/เสนอทางเลือก/บอกเมื่อไม่แน่ใจ ก็ห้ามทำสิ่งเหล่านั้นในการร่างตอน: ห้ามตอบเป็นคำถาม/ตัวเลือก/คำแนะนำ/บทสนทนากับผู้เขียน และห้ามเขียนหมายเหตุความไม่แน่ใจ (เช่น "ไม่แน่ใจว่า...", "ควรตรวจสอบเพิ่มเติม") ลงในเนื้อเรื่อง — ถ้าไม่แน่ใจข้อเท็จจริงใด ให้เลี่ยงไปเล่าเฉพาะสิ่งที่มั่นใจแทน
